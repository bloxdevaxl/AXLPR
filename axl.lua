...
ColorSequenceKeypoint.new(0.50,Color3.fromRGB(12,10,15)),
ColorSequenceKeypoint.new(1.00,Color3.fromRGB(8,8,10))
},
Primary=Color3.fromRGB(138,80,242),
OnPrimary=Color3.fromRGB(90,60,150),
ScrollBar=Color3.fromRGB(120,70,200),
Stroke=Color3.fromRGB(90,50,160),

Error=Color3.fromRGB(255,102,102),
Icons=Color3.fromRGB(232,233,235),

JoinButton=Color3.fromRGB(37,128,69),
Link=Color3.fromRGB(170,110,255),

Dialog={
Background=Color3.fromRGB(6,6,8)
},
Buttons={
Holding=Color3.fromRGB(20,16,26),
Default=Color3.fromRGB(10,9,12)
},
Border={
Holding=Color3.fromRGB(130,80,220),
Default=Color3.fromRGB(90,50,160),
},
Text={
...
Slider={
SliderBar=Color3.fromRGB(120,70,200),
SliderNumber=Color3.fromRGB(232,233,235),
},
Dropdown={
Holder=Color3.fromRGB(10,9,12),
}
},
Icons={
...
Corner=function(H)
return E("UICorner",{
CornerRadius=H or UDim.new(0,14)
})
end,
Stroke=function(H,I)
return E("UIStroke",{
Color=H or Color3.fromRGB(90,50,160),
Thickness=I or 1
})
end,
Image=function(H)
